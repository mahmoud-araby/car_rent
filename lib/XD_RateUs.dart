...
class XD_RateUs extends StatelessWidget {
  XD_RateUs({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(50.0, 192.0),
            child:
                // Adobe XD layer: 'Rate Box' (group)
                SizedBox(
              width: 650.0,
              height: 950.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 650.0, 950.0),
                    size: Size(650.0, 950.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(102.0, 608.0, 447.0, 55.0),
                    size: Size(650.0, 950.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 58.0, 55.0),
                          size: Size(447.0, 55.0),
                          pinLeft: true,
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(99.0, 0.0, 58.0, 55.0),
                          size: Size(447.0, 55.0),
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(196.0, 0.0, 58.0, 55.0),
                          size: Size(447.0, 55.0),
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(291.0, 0.0, 58.0, 55.0),
                          size: Size(447.0, 55.0),
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(389.0, 0.0, 58.0, 55.0),
                          size: Size(447.0, 55.0),
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(50.0, 748.0, 250.0, 100.0),
                    size: Size(650.0, 950.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                    ...
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 250.0, 100.0),
                          size: Size(250.0, 100.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(68.5, 28.0, 114.0, 45.0),
                          size: Size(250.0, 100.0),
                          fixedHeight: true,
                          child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(350.0, 748.0, 250.0, 100.0),
                    size: Size(650.0, 950.0),
                    pinRight: true,
                    pinBottom: true,
                    fixedWidth: true,
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(68.0, 28.0, 114.0, 45.0),
                          size: Size(250.0, 100.0),
                          fixedHeight: true,
                          child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(50.0, 388.0, 550.0, 147.0),
                    size: Size(650.0, 950.0),
                    fixedHeight: true,
                    child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(59.5, 261.0, 532.0, 73.0),
                    size: Size(650.0, 950.0),
                    fixedHeight: true,
                    child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(271.0, 99.0, 108.0, 106.0),
                    size: Size(650.0, 950.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'thumbs_up_down - ma…' (shape)
                        SvgPicture.string(
                      _svg_uf0ayn,
                      allowDrawingOutsideViewBox: true,
                      fit: BoxFit.fill,
