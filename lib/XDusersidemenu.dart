...
import './XDsearchfilter.dart';
import 'package:adobe_xd/page_link.dart';
import './XDmycaraccedent1.dart';

class XDusersidemenu extends StatelessWidget {
  XDusersidemenu({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(97.0, 550.0, 178.0, 56.0),
                    size: Size(550.0, 1334.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      links: [
                        PageLinkInfo(
                          ...
                          ease: Curves.easeOut,
                          duration: 0.3,
                          pageBuilder: () => XDsearchfilter(),
                        ),
                      ],
                      child: Stack(
                        children: <Widget>[
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(0.0, 0.0, 178.0, 56.0),
                            size: Size(178.0, 56.0),
                            fixedHeight: true,
                            child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(97.0, 730.0, 442.0, 101.0),
                    size: Size(550.0, 1334.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(97.0, 831.0, 183.0, 160.0),
                    size: Size(550.0, 1334.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 104.0, 94.0, 56.0),
                          size: Size(183.0, 160.0),
                          fixedHeight: true,
                          child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(91.0, 1115.0, 161.0, 56.0),
                    size: Size(550.0, 1334.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(86.0, 1205.0, 136.0, 56.0),
                    size: Size(550.0, 1334.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(98.0, 1025.0, 307.0, 56.0),
                    size: Size(550.0, 1334.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 307.0, 56.0),
                          size: Size(307.0, 56.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: 'Insurance' (text)
                              Text(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 158.0, 89.0, 51.0),
                    size: Size(122.0, 261.0),
                    fixedHeight: true,
                    child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 0.0, 118.0, 127.0),
                    size: Size(122.0, 261.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
