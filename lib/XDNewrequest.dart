...
class XDNewrequest extends StatelessWidget {
  XDNewrequest({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(341.0, 113.0, 308.0, 43.0),
                    size: Size(750.0, 400.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Order no' (text)
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(222.5, 24.0, 306.0, 48.0),
                  size: Size(750.0, 100.0),
                  fixedHeight: true,
                  child:
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 750.0, 239.0),
                    size: Size(750.0, 239.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(64.0, 39.0, 82.0, 43.0),
                    size: Size(750.0, 239.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Order no' (text)
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(64.0, 164.0, 153.0, 43.0),
                    size: Size(750.0, 239.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Order no' (text)
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(207.0, 39.0, 214.0, 43.0),
                    size: Size(750.0, 239.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Order no' (text)
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(207.0, 88.0, 174.0, 43.0),
                    size: Size(750.0, 239.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Order no' (text)
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(28.0, 0.2, 86.0, 45.0),
                    size: Size(142.0, 51.2),
                    fixedHeight: true,
                    child:
