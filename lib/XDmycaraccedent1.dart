...
class XDmycaraccedent1 extends StatelessWidget {
  XDmycaraccedent1({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(64.0, 61.0, 480.0, 43.0),
                    size: Size(750.0, 122.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Order no' (text)
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(207.0, 12.0, 241.0, 43.0),
                    size: Size(750.0, 122.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Order no' (text)
