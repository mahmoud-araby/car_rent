...
class XDsearchfilter extends StatelessWidget {
  XDsearchfilter({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(685.5, 32.0, 18.0, 36.0),
                    size: Size(750.0, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'plus' (text)
                        Text(
                      '+',
                      style: TextStyle(
                        fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(47.0, 28.0, 73.0, 43.0),
                    size: Size(750.0, 100.0),
                    fixedHeight: true,
                    child:
          ...
          Transform.translate(
            offset: Offset(0.0, 821.0),
            child:
                // Adobe XD layer: 'fuel' (group)
                SizedBox(
              width: 750.0,
              height: 100.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(685.5, 33.0, 18.0, 36.0),
                    size: Size(750.0, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'plus' (text)
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(47.0, 28.0, 140.0, 43.0),
                    size: Size(750.0, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Fuel Type' (text)
                        Text(
                      'Fuel Type',
                      style: TextStyle(
                        fontFamily: 'Poppins',
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(47.0, 28.0, 278.0, 43.0),
                    size: Size(750.0, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Transmission Type' (text)
                        Text(
                      'Transmission Type',
                      style: TextStyle(
                        fontFamily: 'Poppins',
          ...
          Transform.translate(
            offset: Offset(0.0, 621.0),
            child:
                // Adobe XD layer: 'Ratings' (group)
                SizedBox(
              width: 750.0,
              height: 100.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(48.0, 28.0, 112.0, 43.0),
                    size: Size(750.0, 100.0),
                    fixedHeight: true,
                    child:
          ...
          Transform.translate(
            offset: Offset(1.0, 321.0),
            child:
                // Adobe XD layer: 'features' (group)
                SizedBox(
              width: 750.0,
              height: 300.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 750.0, 300.0),
                    size: Size(750.0, 300.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(49.0, 208.0, 221.0, 49.0),
                    size: Size(750.0, 300.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(289.0, 208.0, 219.0, 49.0),
                    size: Size(750.0, 300.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(38.0, 0.0, 181.0, 49.0),
                          size: Size(219.0, 49.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: 'Alloy Wheels' (text)
                              Text(
                            'Alloy Wheels',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(539.0, 208.0, 194.0, 49.0),
                    size: Size(750.0, 300.0),
                    pinRight: true,
                    pinBottom: true,
                    fixedWidth: true,
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(38.0, 0.0, 156.0, 49.0),
                          size: Size(194.0, 49.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: 'GPS' (text)
                              Text(
                            'GPS',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(49.0, 128.0, 221.0, 49.0),
                    size: Size(750.0, 300.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(289.0, 128.0, 205.0, 49.0),
                    size: Size(750.0, 300.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(38.0, 0.0, 167.0, 49.0),
                          size: Size(205.0, 49.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: 'Music Player' (text)
                              Text(
                            'Music Player',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(539.0, 128.0, 194.0, 49.0),
                    size: Size(750.0, 300.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(688.5, 30.0, 14.0, 36.0),
                    size: Size(750.0, 300.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'minus copy' (text)
                        Text(
                      '-',
                      style: TextStyle(
                        fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(47.0, 45.0, 192.0, 43.0),
                    size: Size(750.0, 300.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Car Features' (text)
                        Text(
                      'Car Features',
                      style: TextStyle(
                        fontFamily: 'Poppins',
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 750.0, 222.0),
                    size: Size(750.0, 222.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(50.0, 131.0, 165.0, 49.0),
                    size: Size(750.0, 222.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(39.0, 0.0, 126.0, 49.0),
                          size: Size(165.0, 49.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: '5 Seats' (text)
                              Text(
                            '5 Seats',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(290.0, 131.0, 166.0, 49.0),
                    size: Size(750.0, 222.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(40.0, 0.0, 126.0, 49.0),
                          size: Size(166.0, 49.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: '7 Seats' (text)
                              Text(
                            '7 Seats',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(540.0, 131.0, 155.0, 49.0),
                    size: Size(750.0, 222.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(38.0, 0.0, 117.0, 49.0),
                          size: Size(155.0, 49.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: '8+ Seats' (text)
                              Text(
                            '8+ Seats',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(686.5, 63.0, 20.0, 42.0),
                    size: Size(750.0, 222.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'minus' (text)
                        Text(
                      '-',
                      style: TextStyle(
                        fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(49.0, 60.0, 260.0, 43.0),
                    size: Size(750.0, 222.0),
                    fixedHeight: true,
                    child:
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(238.5, 28.0, 174.0, 45.0),
                    size: Size(650.0, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Apply Filter' (text)
                        Text(
                      'Apply Filter',
                      style: TextStyle(
                        fontFamily: 'Poppins',
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(235.5, 24.0, 280.0, 48.0),
                  size: Size(750.0, 100.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Car Search Filter' (text)
                      Text(
                    'Car Search Filter',
                    style: TextStyle(
                      fontFamily: 'Poppins',
