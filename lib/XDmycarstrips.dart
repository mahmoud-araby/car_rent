...
class XDmycarstrips extends StatelessWidget {
  XDmycarstrips({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(341.0, 61.0, 166.0, 43.0),
                    size: Size(750.0, 400.0),
                    fixedHeight: true,
                    child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(341.0, 181.0, 288.0, 36.0),
                    size: Size(750.0, 400.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'date' (text)
                        Text(
                      'Sat, 15 Aug, 18 07:00PM',
                      style: TextStyle(
                        fontFamily: 'Poppins',
                        fontSize: 26,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(341.0, 294.0, 99.0, 43.0),
                    size: Size(750.0, 400.0),
                    fixedHeight: true,
                    child:
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(341.0, 61.0, 204.0, 43.0),
                    size: Size(750.0, 400.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Order no' (text)
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(341.0, 181.0, 277.0, 36.0),
                    size: Size(750.0, 400.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'date' (text)
                        Text(
                      'Fri, 14 Aug, 18 06:00PM',
                      style: TextStyle(
                        fontFamily: 'Poppins',
                        fontSize: 26,
                        color: const Color(0xffbdbdbd),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(341.0, 238.0, 244.0, 36.0),
                    size: Size(750.0, 400.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Car' (text)
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(341.0, 294.0, 91.0, 43.0),
                    size: Size(750.0, 400.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'price' (text)
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 142.0, 51.2),
                    size: Size(295.0, 51.2),
                    pinLeft: true,
                    pinTop: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(31.0, 0.2, 80.0, 45.0),
                    size: Size(295.0, 51.2),
                    fixedHeight: true,
                    child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(153.0, 0.0, 142.0, 51.2),
                    size: Size(295.0, 51.2),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(157.0, 0.2, 134.0, 45.0),
                    size: Size(295.0, 51.2),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Book now' (text)
