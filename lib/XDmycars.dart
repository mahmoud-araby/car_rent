...
class XDmycars extends StatelessWidget {
  XDmycars({
    Key key,
  }) : super(key: key);
  @override
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(306.5, 24.0, 138.0, 48.0),
                  size: Size(750.0, 100.0),
                  fixedHeight: true,
                  child:
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 247.3, 51.2),
                    size: Size(247.3, 51.2),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(95.0, 3.5, 58.0, 45.0),
                    size: Size(247.3, 51.2),
                    fixedHeight: true,
                    child:
