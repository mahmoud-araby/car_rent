...
class XD_CarOwnerProfile extends StatelessWidget {
  XD_CarOwnerProfile({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(223.5, 27.0, 204.0, 45.0),
                    size: Size(650.0, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'View All Cars' (text)
                        Text(
                      'View All Cars',
                      style: TextStyle(
                        fontFamily: 'Poppins',
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 64.0, 650.0, 168.0),
                    size: Size(650.0, 232.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child:
                        ...
                        Text(
                      'Garrett is a car lover and enthusiastic. He has been supplying cars on rent since last 5 years on our app. He is most trusted car owner today on our app.',
                      style: TextStyle(
                        fontFamily: 'Poppins',
                        fontSize: 26,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(179.0, 0.0, 296.6, 49.0),
                    size: Size(650.0, 232.0),
                    fixedHeight: true,
                    child:
          ...
          Transform.translate(
            offset: Offset(50.0, 699.0),
            child:
                // Adobe XD layer: 'counters' (group)
                SizedBox(
              width: 653.0,
              height: 155.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(485.0, 36.0, 168.0, 93.0),
                    size: Size(653.0, 154.5),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 57.0, 168.0, 36.0),
                          size: Size(168.0, 93.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: 'Recommend' (text)
                              Text(
                            'Recommend',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(62.5, 0.0, 54.0, 51.0),
                          size: Size(168.0, 93.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: '231' (text)
                              Text(
                            '231',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(242.0, 36.0, 166.0, 93.0),
                    size: Size(653.0, 154.5),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'on rent' (group)
                        Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(73.0, 0.0, 22.0, 51.0),
                          size: Size(166.0, 93.0),
                          fixedHeight: true,
                          child:
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 57.0, 166.0, 36.0),
                          size: Size(166.0, 93.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: 'Cars on Rent' (text)
                              Text(
                            'Cars on Rent',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(3.0, 36.0, 97.0, 93.0),
                    size: Size(653.0, 154.5),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(2.5, 0.0, 90.0, 51.0),
                          size: Size(97.0, 93.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: '4.7/5' (text)
                              Text(
                            '4.7/5',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 57.0, 97.0, 36.0),
                          size: Size(97.0, 93.0),
                          fixedHeight: true,
                          child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 650.0, 1.0),
                    size: Size(653.0, 154.5),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Separator 1' (shape)
                        SvgPicture.string(
                      _svg_mcnfca,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 154.0, 650.0, 1.0),
                    size: Size(653.0, 154.5),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
          ...
          Transform.translate(
            offset: Offset(132.0, 548.0),
            child:
                // Adobe XD layer: 'Owner' (group)
                SizedBox(
              width: 487.0,
              height: 118.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(175.5, 75.0, 136.0, 43.0),
                    size: Size(487.0, 118.0),
                    fixedHeight: true,
                    child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 487.0, 68.0),
                    size: Size(487.0, 118.0),
                    fixedHeight: true,
                    child:
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(228.5, 26.0, 294.0, 48.0),
                  size: Size(750.0, 100.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Car Owner Profile' (text)
                      Text(
                    'Car Owner Profile',
                    style: TextStyle(
                      fontFamily: 'Poppins',
...
const String _svg_mcnfca =
    '<svg viewBox="0.0 1.0 650.0 1.0" ><path  d="M 0 1.524954080581665 L 649.9998168945313 1" fill="none" stroke="#cccccc" stroke-width="1" stroke-miterlimit="10" stroke-linecap="square" /></svg>';
const String _svg_ufz7bg =
    '<svg viewBox="0.0 155.0 650.0 1.0" ><path transform="translate(0.0, 154.0)" d="M 0 1.524954080581665 L 649.9998168945313 1" fill="none" stroke="#cccccc" stroke-width="1" stroke-miterlimit="10" stroke-linecap="square" /></svg>';
