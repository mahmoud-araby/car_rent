...
class XDaddacar extends StatelessWidget {
  XDaddacar({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Transform.translate(
            offset: Offset(50.0, 1176.4),
            child:
                // Adobe XD layer: 'book now' (group)
                SizedBox(
              width: 650.0,
              height: 100.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(293.5, 28.0, 64.0, 45.0),
                    size: Size(650.0, 100.0),
                    fixedHeight: true,
                    child:
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 266.5, 100.0),
                    size: Size(266.5, 100.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(87.8, 28.5, 91.0, 43.0),
                    size: Size(266.5, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: '5 Days Trip' (text)
                        Text(
                      'Model',
                      style: TextStyle(
                        fontFamily: 'Poppins',
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(305.0, 24.0, 140.0, 48.0),
                  size: Size(750.0, 100.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Book a Car' (text)
                      Text(
                    'Add Car',
                    style: TextStyle(
                      fontFamily: 'Poppins',
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 315.0, 100.0),
                    size: Size(315.0, 100.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(103.7, 28.5, 91.0, 43.0),
                    size: Size(315.0, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: '5 Days Trip' (text)
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 311.6, 100.0),
                    size: Size(311.6, 100.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(103.8, 28.5, 89.0, 43.0),
                    size: Size(311.6, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: '5 Days Trip' (text)
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(114.4, 28.5, 73.0, 43.0),
                    size: Size(315.0, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: '5 Days Trip' (text)
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(68.7, 28.5, 149.0, 43.0),
                    size: Size(311.6, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: '5 Days Trip' (text)
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 670.0, 147.6),
                    size: Size(670.0, 147.6),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(260.5, 49.5, 169.0, 43.0),
                    size: Size(670.0, 147.6),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: '5 Days Trip' (text)
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(103.7, 28.5, 154.0, 43.0),
                    size: Size(315.0, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: '5 Days Trip' (text)
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(103.8, 28.5, 109.0, 43.0),
                    size: Size(311.6, 100.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: '5 Days Trip' (text)
