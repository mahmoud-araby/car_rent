    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 55.0, 326.0, 49.0),
                    size: Size(326.0, 104.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 0.0, 296.6, 49.0),
                    size: Size(326.0, 104.0),
                    fixedHeight: true,
                    child:
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 55.0, 179.0, 49.0),
                    size: Size(298.6, 104.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            offset: Offset(378.0, 1074.0),
            child:
                // Adobe XD layer: 'Country' (group)
                SizedBox(
              width: 306.0,
              height: 104.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 55.0, 306.0, 49.0),
                    size: Size(306.0, 104.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 0.0, 231.0, 49.0),
                    size: Size(306.0, 104.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Title' (text)
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 55.0, 202.0, 49.0),
                    size: Size(202.0, 104.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 0.0, 65.0, 49.0),
                    size: Size(202.0, 104.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Title' (text)
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 55.0, 650.0, 168.0),
                    size: Size(650.0, 223.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child:
                        ...
                        Text(
                      'Eva is traveller lover. She loves to visit new places during whole year. She is always renting cars on this app. One of the top rated car hirer on our app. Very professional and courtious as well.',
                      style: TextStyle(
                        fontFamily: 'Poppins',
                        fontSize: 26,
                        color: const Color(0xffbdbdbd),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 296.6, 49.0),
                    size: Size(650.0, 223.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Title' (text)
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 750.0, 496.0),
                    size: Size(750.0, 496.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    ...
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(271.0, 398.0, 208.0, 43.0),
                          size: Size(750.0, 496.0),
                          fixedHeight: true,
                          child:
                              // Adobe XD layer: 'Designation' (text)
                              Text(
                            'New York, USA',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(128.0, 331.0, 495.0, 68.0),
                          size: Size(750.0, 496.0),
                          fixedHeight: true,
                          child:
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(282.5, 26.0, 186.0, 48.0),
                  size: Size(750.0, 100.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'User Profile' (text)
                      Text(
                    'User Profile',
                    style: TextStyle(
                      fontFamily: 'Poppins',
