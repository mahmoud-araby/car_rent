...
class XD_CarReviews extends StatelessWidget {
  XD_CarReviews({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            bounds: Rect.fromLTWH(50.0, 1050.0, 657.0, 250.0),
            ...
            child:
              ...
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(100.0, 0.0, 557.0, 250.0),
                  size: Size(657.0, 250.0),
                  pinLeft: true,
                  pinRight: true,
                  pinTop: true,
                  pinBottom: true,
                  child:
                      // Adobe XD layer: 'Message Background' (shape)
                      Container(
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 50.0, 150.0, 150.0),
                  size: Size(657.0, 250.0),
                  pinLeft: true,
                  pinTop: true,
                  pinBottom: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(198.5, 33.0, 135.0, 43.0),
                  size: Size(657.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Scott Lee' (text)
                      Text(
                    'Scott Lee',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(206.0, 94.0, 400.0, 93.0),
                  size: Size(657.0, 250.0),
                  pinRight: true,
                  fixedWidth: true,
                  fixedHeight: true,
                  child:
                      ...
                      Text(
                    'This is the best app for car rent and hire.',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                      fontSize: 26,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(206.0, 187.0, 88.0, 28.0),
                  size: Size(657.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Just now' (text)
                      Text(
                    'Just now',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(549.0, 187.0, 65.0, 28.0),
                  size: Size(657.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: '2 likes' (text)
                      Text(
                    '2 likes ',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(455.0, 187.0, 60.0, 28.0),
                  size: Size(657.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Reply' (text)
                      Text(
                    'Reply ',
                    style: TextStyle(
                      fontFamily: 'Poppins',
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(50.0, 750.0, 651.0, 250.0),
            size: Size(750.0, 1334.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child:
              ...
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(100.0, 0.0, 551.0, 250.0),
                  size: Size(651.0, 250.0),
                  pinLeft: true,
                  pinRight: true,
                  pinTop: true,
                  pinBottom: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(197.5, 34.0, 247.0, 43.0),
                  size: Size(651.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Maggie Sanchez' (text)
                      Text(
                    'Maggie Sanchez',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(200.0, 85.0, 400.0, 93.0),
                  size: Size(651.0, 250.0),
                  pinRight: true,
                  fixedWidth: true,
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'message' (text)
                      Text(
                    'Booking car from this app is always fruitful.',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                      fontSize: 26,
                      color: const Color(0xffbdbdbd),
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(200.0, 187.0, 88.0, 28.0),
                  size: Size(651.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Just now' (text)
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(543.0, 187.0, 65.0, 28.0),
                  size: Size(651.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: '2 likes' (text)
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(449.0, 187.0, 60.0, 28.0),
                  size: Size(651.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Reply' (text)
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(50.0, 450.0, 651.0, 250.0),
            size: Size(750.0, 1334.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(198.0, 33.0, 272.0, 43.0),
                  size: Size(651.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Daniel McCormick' (text)
                      Text(
                    'Daniel McCormick',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromSize(
                  ...
                  child:
                      // Adobe XD layer: 'message' (text)
                      Text(
                    'Very good services. We are so happy.',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                      fontSize: 26,
                      color: const Color(0xffbdbdbd),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(50.0, 150.0, 651.0, 250.0),
            size: Size(750.0, 1334.0),
            pinLeft: true,
            pinRight: true,
            pinTop: true,
            ...
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(199.0, 33.0, 264.0, 43.0),
                  size: Size(651.0, 250.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Christina Harmon' (text)
                      Text(
                    'Christina Harmon',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(200.0, 94.0, 400.0, 93.0),
                  size: Size(651.0, 250.0),
                  pinRight: true,
                  fixedWidth: true,
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'message' (text)
                      Text(
                    'Perfect car for long vacation trip with family.',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                      fontSize: 26,
                      color: const Color(0xffbdbdbd),
          ...
          Pinned.fromSize(
            ...
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(272.5, 24.0, 206.0, 48.0),
                  size: Size(750.0, 100.0),
                  fixedHeight: true,
                  child:
                      // Adobe XD layer: 'Car Reviews' (text)
                      Text(
                    'Car Reviews',
                    style: TextStyle(
                      fontFamily: 'Poppins',
