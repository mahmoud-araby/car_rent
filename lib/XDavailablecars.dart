...
import './XD_PickUp.dart';
import 'package:adobe_xd/page_link.dart';
import './XDnearmeview.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDavailablecars extends StatelessWidget {
  XDavailablecars({
    Key key,
  }) : super(key: key);
  @override
                          ...
                          Pinned.fromSize(
                            ...
                            child:
                              ...
                              children: <Widget>[
                                ...
                                Pinned.fromSize(
                                  bounds:
                                      Rect.fromLTWH(174.0, 82.0, 26.0, 26.0),
                                  size: Size(200.0, 108.0),
                                  pinRight: true,
                                  pinBottom: true,
                                  fixedWidth: true,
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(341.0, 294.0, 98.0, 43.0),
                      size: Size(750.0, 400.0),
                      fixedHeight: true,
                      child:
                          // Adobe XD layer: 'price' (text)
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(210.5, 24.0, 330.0, 48.0),
                  size: Size(750.0, 100.0),
                  fixedHeight: true,
                  child:
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(212.5, 28.0, 226.0, 45.0),
                      size: Size(650.0, 100.0),
                      fixedHeight: true,
                      child:
